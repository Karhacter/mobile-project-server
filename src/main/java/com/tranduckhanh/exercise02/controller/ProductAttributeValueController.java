...
public class ProductAttributeValueController {
    ...
    @PostMapping
    public ResponseEntity<ProductAttributeValue> createProductAttributeValue(
            @RequestBody ProductAttributeValue productAttributeValue) {
        ProductAttributeValue savedProductAttributeValue = productAttributeValueService
    ...
    @GetMapping("{id}")
    public ResponseEntity<ProductAttributeValue> getProductAttributeValueById(
            @PathVariable("id") String productAttributeValueId) {
        ProductAttributeValue productAttributeValue = productAttributeValueService
                .getProductAttributeValueById(productAttributeValueId);
