...
import com.tranduckhanh.exercise02.service.ProductShippingInfoService;
...
public class ProductShippingInfoController {
    ...
    @PostMapping
    public ResponseEntity<ProductShippingInfo> createProductShippingInfo(
            @RequestBody ProductShippingInfo productShippingInfo) {
        ProductShippingInfo savedProductShippingInfo = productShippingInfoService
                .createProductShippingInfo(productShippingInfo);
    ...
    @GetMapping("{id}")
    public ResponseEntity<ProductShippingInfo> getProductShippingInfoById(
            @PathVariable("id") String productShippingInfoId) {
        ProductShippingInfo productShippingInfo = productShippingInfoService
                .getProductShippingInfoById(productShippingInfoId);
    ...
    @PutMapping("{id}")
    // http://localhost:8080/api/productShippingInfos/{id}
    public ResponseEntity<ProductShippingInfo> updateProductShippingInfo(
            @PathVariable("id") String productShippingInfoId,
            @RequestBody ProductShippingInfo productShippingInfo) {
        productShippingInfo.setProductShippingInfoId(productShippingInfoId);
        ProductShippingInfo updatedProductShippingInfo = productShippingInfoService
                .updateProductShippingInfo(productShippingInfo);
