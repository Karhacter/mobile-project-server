...
import com.tranduckhanh.exercise02.repository.AttributeValueRepository;
import com.tranduckhanh.exercise02.service.AttributeValueService;
...
public class AttributeValueServiceImpl implements AttributeValueService {
    ...
    public AttributeValue updateAttributeValue(AttributeValue attributeValue) {
        Optional<AttributeValue> optionalExistingAttributeValue = attributeValueRepository
                .findById(attributeValue.getAttributeValueId());
