...
import com.tranduckhanh.exercise02.repository.CustomerAddressRepository;
import com.tranduckhanh.exercise02.service.CustomerAddressService;
...
public class CustomerAddressServiceImpl implements CustomerAddressService {
    ...
    public CustomerAddress updateCustomerAddress(CustomerAddress customerAddress) {
        Optional<CustomerAddress> optionalExistingCustomerAddress = customerAddressRepository
                .findById(customerAddress.getCustomerAddressId());
