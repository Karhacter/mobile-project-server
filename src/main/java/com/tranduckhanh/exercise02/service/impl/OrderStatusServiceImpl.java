...
import com.tranduckhanh.exercise02.repository.OrderStatusRepository;
import com.tranduckhanh.exercise02.service.OrderStatusService;
...
public class OrderStatusServiceImpl implements OrderStatusService {
    ...
    public OrderStatus updateOrderStatus(OrderStatus orderStatus) {
        Optional<OrderStatus> optionalExistingOrderStatus = orderStatusRepository
                .findById(orderStatus.getOrderStatusId());
