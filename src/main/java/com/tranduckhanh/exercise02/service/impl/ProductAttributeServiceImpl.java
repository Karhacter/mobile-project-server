...
import com.tranduckhanh.exercise02.repository.ProductAttributeRepository;
import com.tranduckhanh.exercise02.service.ProductAttributeService;
...
public class ProductAttributeServiceImpl implements ProductAttributeService {
    ...
    public ProductAttribute updateProductAttribute(ProductAttribute productAttribute) {
        Optional<ProductAttribute> optionalExistingProductAttribute = productAttributeRepository
                .findById(productAttribute.getProductAttributeId());
