...
import com.tranduckhanh.exercise02.repository.ProductAttributeValueRepository;
import com.tranduckhanh.exercise02.service.ProductAttributeValueService;
...
public class ProductAttributeValueServiceImpl implements ProductAttributeValueService {
    ...
    public ProductAttributeValue getProductAttributeValueById(String productAttributeValueId) {
        Optional<ProductAttributeValue> optionalProductAttributeValue = productAttributeValueRepository
    ...
    public ProductAttributeValue updateProductAttributeValue(ProductAttributeValue productAttributeValue) {
        Optional<ProductAttributeValue> optionalExistingProductAttributeValue = productAttributeValueRepository
                .findById(productAttributeValue.getProductAttributeValueId());
        if (optionalExistingProductAttributeValue.isPresent()) {
            ...
            ProductAttributeValue updatedProductAttributeValue = productAttributeValueRepository
                    .save(existingProductAttributeValue);
