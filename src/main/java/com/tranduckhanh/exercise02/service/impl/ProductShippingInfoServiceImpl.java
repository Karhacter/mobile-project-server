...
import com.tranduckhanh.exercise02.repository.ProductShippingInfoRepository;
...
public class ProductShippingInfoServiceImpl implements ProductShippingInfoService {
    ...
    public ProductShippingInfo getProductShippingInfoById(String productShippingInfoId) {
        Optional<ProductShippingInfo> optionalProductShippingInfo = productShippingInfoRepository
                .findById(productShippingInfoId);
    ...
    public ProductShippingInfo updateProductShippingInfo(ProductShippingInfo productShippingInfo) {
        Optional<ProductShippingInfo> optionalExistingProductShippingInfo = productShippingInfoRepository
                .findById(productShippingInfo.getProductShippingInfoId());
        if (optionalExistingProductShippingInfo.isPresent()) {
            ...
            ProductShippingInfo updatedProductShippingInfo = productShippingInfoRepository
                    .save(existingProductShippingInfo);
