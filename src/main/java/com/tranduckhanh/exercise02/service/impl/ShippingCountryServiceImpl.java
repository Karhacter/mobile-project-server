...
import com.tranduckhanh.exercise02.repository.ShippingCountryRepository;
import com.tranduckhanh.exercise02.service.ShippingCountryService;
...
public class ShippingCountryServiceImpl implements ShippingCountryService {
    ...
    public ShippingCountry updateShippingCountry(ShippingCountry shippingCountry) {
        Optional<ShippingCountry> optionalExistingShippingCountry = shippingCountryRepository
                .findById(shippingCountry.getShippingCountryId());
