...
import com.tranduckhanh.exercise02.repository.ShippingRateRepository;
import com.tranduckhanh.exercise02.service.ShippingRateService;
...
public class ShippingRateServiceImpl implements ShippingRateService {
    ...
    public ShippingRate updateShippingRate(ShippingRate shippingRate) {
        Optional<ShippingRate> optionalExistingShippingRate = shippingRateRepository
                .findById(shippingRate.getShippingRateId());
