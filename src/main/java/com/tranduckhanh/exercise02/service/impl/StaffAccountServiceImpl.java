...
import com.tranduckhanh.exercise02.repository.StaffAccountRepository;
import com.tranduckhanh.exercise02.service.StaffAccountService;
...
public class StaffAccountServiceImpl implements StaffAccountService {
    ...
    public StaffAccount updateStaffAccount(StaffAccount staffAccount) {
        ...
        return null; // Hoặc xử lý theo yêu cầu của bạn khi không tìm thấy tài khoản nhân viên tồn
                     // tại
    }
