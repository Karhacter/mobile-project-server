...
import com.tranduckhanh.exercise02.repository.VariantOptionRepository;
import com.tranduckhanh.exercise02.service.VariantOptionService;
...
public class VariantOptionServiceImpl implements VariantOptionService {
    ...
    public VariantOption updateVariantOption(VariantOption variantOption) {
        Optional<VariantOption> optionalExistingVariantOption = variantOptionRepository
                .findById(variantOption.getVariantOptionId());
