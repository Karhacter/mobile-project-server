...
import com.tranduckhanh.exercise02.repository.VariantValueRepository;
import com.tranduckhanh.exercise02.service.VariantValueService;
...
public class VariantValueServiceImpl implements VariantValueService {
    ...
    public VariantValue updateVariantValue(VariantValue variantValue) {
        Optional<VariantValue> optionalExistingVariantValue = variantValueRepository
                .findById(variantValue.getVariantValueId());
